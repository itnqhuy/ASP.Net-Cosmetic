...
<script runat="server">
    ...
    public override void SetConfig()
    {
        ...
        BaseUrl = "/plugin/ckfinder/userfiles/";  // URL truy cập từ trình duyệt
        BaseDir = Path.Combine(Directory.GetCurrentDirectory(), "wwwroot", "plugin", "ckfinder", "userfiles"); // Thư mục trên server
        ...
        if (BaseDir != "") Thumbnails.Dir = BaseDir + "_thumbs/";
