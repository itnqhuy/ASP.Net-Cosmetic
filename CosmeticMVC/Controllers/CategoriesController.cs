...
namespace CosmeticMVC.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdCategory,Name,Meta,Hide,Order,Datebegin")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("IdCategory,Name,Meta,Hide,Order,Datebegin")] Category category)
        {
